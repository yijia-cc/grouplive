...
func (c *authenticationServiceClient) VerifyIdentity(ctx context.Context, in *VerifyIdentityRequest, opts ...grpc.CallOption) (*VerifyIdentityResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pb.AuthenticationService/VerifyIdentity", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AuthenticationService_VerifyIdentity_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.AuthenticationService/VerifyIdentity",
	}
...
func (c *authorizationServiceClient) HasPermission(ctx context.Context, in *HasPermissionRequest, opts ...grpc.CallOption) (*HasPermissionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pb.AuthorizationService/HasPermission", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AuthorizationService_HasPermission_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.AuthorizationService/HasPermission",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
