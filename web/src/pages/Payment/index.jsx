...
const stripePromise = loadStripe('pk_test_51IzocuKQk9KU3MqkabrDG5mjd4kpEZ5FnW99S16rzdAshD6miUfJXUhM3S4JCpRFV6g1cJzTFwujahgO4TsXhyrd003IQE3AUz');
...
function Payment(props) {
  const handleClick = async (event) => {
    ...
    const response = await fetch('http://localhost:4242/create-checkout-session', settings);
  ...
  //                 <hr></hr>
  //                 </form>
  //                 <button class="w-100 btn btn-primary btn-lg" role="link" onClick={handleClick}>Pay with Stripe now!</button>
